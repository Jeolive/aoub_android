...
import com.olive.aoub_android.sdk.model.header.AppInfo;
import com.olive.aoub_android.sdk.model.header.DeviceInfo;
import com.olive.aoub_android.sdk.model.header.HeaderInfo;
import com.olive.aoub_android.sdk.model.header.NetworkInfo;
...
public class TcHeadrHandle {
    ...
    private static AppInfo getAppInfo(Context context) {
        ...
        try {
            ...
            appinfo.setSdk_version_name(DeviceUtil.getSdkName());
