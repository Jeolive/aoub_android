...
public class TcStatPollMgr {
	...
	private TcStatManagerImpl staticsManagerImpl;
	/** 心跳周期 */
	 ...
	 * Constructor
	 */
	public TcStatPollMgr(TcStatManagerImpl staticsManager) {
		...
		protected Handler initialValue() {
			return new Handler(Looper.getMainLooper()) {
				...
				public void handleMessage(Message msg) {
					switch (msg.what) {
						case MSG_TIMEOUT:
							TcStatPollMgr schedule = (TcStatPollMgr) msg.obj;
							if (schedule != null) {
								schedule.onTimeOut();
